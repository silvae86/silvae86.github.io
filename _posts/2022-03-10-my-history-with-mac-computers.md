...
The OS was truly **fun** to use, even more so than Windows XP. The subtle, pulsing glow of the default button in a modal window in Snow Leopard...I just love the skeuomorphic design from those days! And while some may consider Windows XP childish and plasticky, I also continue to enjoy its contrast-y intuitive colors back then. The typography on a Mac always looked better. The subtle animations when a window was minimised and maximised were not only technically impressive for the time, but elegant at the same time. More than providing useless flourish, they served a purpose and helped the user understand where the window went. 

![Lickable Buttons in a modal dialog box in OS X Snow Leopard](/assets/images/post-images/2022-03-04-using-a-vintage-mac-with-106-snow-leopard-in-2022/lickable-buttons.png){:class="img-center"}
*Some "lickable" Buttons in a modal dialog box in OS X Snow Leopard.*{:class="img-caption"}
